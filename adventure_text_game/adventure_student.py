...
def získej_akci_hráče() -> str:
    """
    Zeptá se hráče, jakou chce provést akci a vrátí tuto akci
    """
    ############## Doplň kód ###############
...
"""
    ...
    Nápověda 2: seznam akcí byl uveden v předešlém úkolu
"""
...
def obchodovat(charakter):
    ...
    ############## Doplň kód ###############
    # Odečti charakteru peníze a vypiš název zakoupeného předmětu a kolik peněz charakteru zbývá
...
"""
    ...
    2. Přidej zvuk pro boj pomocí funkce 'hrej_zvuk' - podívej se do složky zvuky, jaké zvuky máš k dispozici
